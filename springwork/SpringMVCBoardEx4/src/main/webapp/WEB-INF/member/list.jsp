...
<h3>총 회원수는 : ${totalCount } 명 입니다</h3>
	...
	<tr>
		...
		<td style="width:220px" valign="middle">
				...
				핸드폰 : ${dto.hp }<br>
				이메일 : ${dto.email }<br>
				가입일 : <fmt:formatDate value="${dto.gaipday }" pattern="yyyy-MM-dd HH:mm"/><br><br>
				
				<c:if test="${loginok!=null and loginemail == dto.email}">
				<button type="button" class="btn btn-outline-success btn-sm" 
				 onclick="location.href='./updateform?num=${dto.num}'">수정</button>
				<button type="button" class="btn btn-outline-success btn-sm" onclick="delmember(${dto.num})">삭제</button>
				</c:if>
