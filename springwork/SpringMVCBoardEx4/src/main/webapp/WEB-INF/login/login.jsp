...
<body>
<i class="bi bi-house" style="font-size:30px;cursor:pointer;color:red;margin:30px 50px;" onclick="location.href='../'"></i>
<div class="loginbox">
	...
	<form action="loginaction" method="post">
		<table class="table" style="width:230px">
			...
			${!(saveemail==null or saveemail=='no')?"checked":"" }>이메일저장</label>
			</span>
			</caption>
			<tr>
			...
			<tr>
				<td colspan="2" align="center">
					<button type="submit" class="btn btn-outline-secondary" style="width:120px">회원로그인</button>
				</td>
			</tr>	
		</table>
	</form>
