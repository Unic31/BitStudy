  ...
  <div class="modal-dialog">
	...
	<table class="table table-border" style="width: 800px;">
		...
		for (PersonDto dto : list) {
			int age = currYear - dto.getYear();
		%>
		<tr>
			<td align="center"><%=n++%></td>
			<td><img src="../image/moviestar/<%=dto.getPhoto()%>" width="30"
				border="1" hspace="10" class="photo" data-bs-toggle="modal" data-bs-target="#photoModal"> <b> <%=dto.getName()%></b>
			</td>
			<td><%=age%>세(<%=dto.getYear()%>년생)</td>
			<td><%=dto.getAdd()%></td>
			<td><%=dto.getJob()%></td>
			<td>
				<!-- js에서 이동은 "location.href='' "해야함 -->
