...
%>
<body>
	<h4 class="alert alert-danger" style="width: 400px">Mysql Person
		데이터 수정</h4>
		...
		<table class="table table-bordered" style="width: 400px">
			<tr>
				...
				<td><input type="text" name="name" required="required"
					class="form-conntrol" value="<%=dto.getName()%>"></td>
			</tr>
			<tr>
				<th bgcolor="lightgray" width="100">태어난 년도</th>
				<td><select class="form-select" name="birthyear">
						<%
						Date date = new Date();
			...
			<tr>
				...
				<td><select class="form-select" name="job">
						<%
				...
				<td>
					<div>
						<select class="form-select" name="photo" id="photo">
							...
							%>
							<option value="<%=i%>.jpg"
								<%=s.equals(dto.getPhoto()) ? "selected" : ""%>><%=i%>번 사진
							</option>
							<%
							}
							%>
	...
	<img src="../image/moviestar/<%=dto.getPhoto()%>" id="photoview"
		width="200" border="1"
