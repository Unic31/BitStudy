<%@page import="study.dayd021.AnimalDto"%>
<%@page import="java.util.List"%>
<%@page import="study.dayd021.AnimalList"%>
...
<%
	AnimalList aniamlList=new AnimalList();

	//list 데이터 가져오기
	List<AnimalDto> list=aniamlList.getAllAnimals();
%>
<table class="table table-bordered" style="width:400px">
	...
	for(AnimalDto dto:list){
		...
		<td >
			<img width="100" src="../image/animal/<%= dto.getAnimalPhoto() %>.png">
		</td>
		</tr>
	<%}
