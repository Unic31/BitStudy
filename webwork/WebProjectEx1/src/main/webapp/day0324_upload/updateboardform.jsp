...
<body>
	<div style="margin: 30px 50px">
		...
		<img id="showimg" src="../save/<%=dto.getPhoto()%>"
			style="position: absolute; left: 520px; top: 100px; max-width: 300px;">
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="subject" class="form-control"
						required="required" value="<%=dto.getSubject()%>"></td>
				</tr>
				<tr>
					<th bgcolor="lightgray" width="100">사진(1장)</th>
				...
				<tr>
					<td colspan="2" align="center">
						<button type="submit" class="btn btn-secondary btn-sm">게시글
							수정</button>
