...
<body>
	<div style="margin: 30px 50px">
		...
		<table class="table table-bordered"
			...
			<caption align="top">
				<b><%=list.size() == 0 ? "Simple Board" : "총 " + list.size() + "개의 글이 있습니다"%></b>
			</caption>
			...
			%>
			<tr height="60">
				<td colspan="5" align="center" valign="middle"><b>게시글이 없습니다</b>
				</td>
			</tr>
			...
			<tr>
				...
				<td><a href="detailboard.jsp?num=<%=dto.getNum()%>"> <%=dto.getSubject()%>
						<%
