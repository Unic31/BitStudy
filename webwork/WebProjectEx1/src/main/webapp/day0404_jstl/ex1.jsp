...
<table class="table table-bordered" style="width:500px">
	...
	<tr style="background-color:#ccc">
		<th width=300px>EL태그</th><th width=300px>결과</th>
	</tr>
	
	<tr><%-- $ 앞에 \를 붙히면 ${} 안의 내용이 그대로 나옴--%>
		<td>\${su1+su2 }</td>
		<td>${su1+su2 }</td>
	</tr>
	...
	<tr>
		...
		<td>${requestScope.name },${name }</td><%--requestScope는 기본값이라 생략가능 --%>
	</tr>
	
	<tr>
		<td>session영역의 변수 출력</td>
		<td>${sessionScope.loginid }</td><%--sessionScope는생략 불가능--%>
	</tr>
	
	<tr>
		<td>session을 이용한 조건 연산자</td>
