...
//			System.out.println("로컬 Mysql 연결 성공");
	...
	public void writeSawon() {
		...
		String sql = "select sawon.num,name,gender,buseo,age,hp,addr,score" + " from sawon"
...
//		ex2.writeSawon();
	...
	private void bunseokSawon() {
		// TODO Auto-generated method stub
		Connection conn = this.getConnection();
		String sql="select buseo  ,count(*) count, round(avg(score),-1) avgscore, max(score) maxscore, min(score) minscore from sawon group by buseo";
