...
public class Ex11File {
	static final String FILENAME1 = "C:\\bit701naver/info.txt";
	...
	public static void infoRead() {
		...
		try {
			...
			System.out.println("파일이 없습니다. 먼제 데이터를 저장해주세요");
		} catch (IOException e) {
	...
	public static void fileSave() {
		...
		FileWriter fw = null;
		try {
			fw = new FileWriter(FILENAME1, true);// append추가모드로 생성
			// 이름과 주소를 입력받아 파일에 저장
	...
	public static void fileDelete() {
		Scanner sc = new Scanner(System.in);
		System.out.println("삭제를 하려면 Y 를 눌러주세요");
