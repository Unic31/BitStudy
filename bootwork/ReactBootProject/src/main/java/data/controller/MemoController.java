...
public class MemoController {
	...
	public String transEng(@RequestParam(defaultValue = "") String korMsg) {
		...
		String clientId = "eggmgjtmq4";
		String clientSecret = "t0ZNs2hIob0G1bWOcd11moIHzbo8tfm6rSDXXdWS";//애플리케이션 클라이언트 시크릿값";
		try {
...
//	@PostMapping("/trans")
//	public String transEng(@RequestBody String korMsg) {
//		System.out.println("trans>>"+korMsg);
//		String clientId = "eggmgjtmq4";
//		String clientSecret = "t0ZNs2hIob0G1bWOcd11moIHzbo8tfm6rSDXXdWS";//애플리케이션 클라이언트 시크릿값";
//		try {
...
//	}
	...
	@GetMapping("/list")
	public List<MemoDto> getlist(@RequestParam String keyword){
		System.out.println("list");
		System.out.println(keyword);
		return memoService.getAllMemos(keyword);
	}
