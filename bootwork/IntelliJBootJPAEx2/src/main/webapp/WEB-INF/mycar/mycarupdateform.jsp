    ...
    <form action="update" method="post" enctype="multipart/form-data">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="carname" value="${dto.carname}" class="form-control" style="width: 200px">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="carprice" value="${dto.carprice}" class="form-control" style="width: 200px">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" align="center">
                    ...
                    <button type="button" class="btn btn-outline-secondary" onclick="location.href='/'">자동차목록</button>
                </td>
            </tr>
        </table>
