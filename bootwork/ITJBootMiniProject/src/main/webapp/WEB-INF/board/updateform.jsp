    ...
    <form action="update" method="post" enctype="multipart/form-data">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control" name="writer" value="${dto.writer}" required>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2">
                    <textarea style="width: 100%;height: 130px;" name="content" required class="form-control">${dto.content}</textarea>
                </td>
            </tr>
            <tr>
